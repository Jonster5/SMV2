...
Scoreboard.prototype.ensureDom = function() {
  ...
  el.style.backgroundColor = '#4e607c';
  el.style.zIndex = 4;
  el.style.opacity = 1;
  ...
  help_el.style.borderTop = "4px #4c4c4c solid";
  help_el.style.marginTop = '2.5px';
  help_el.style.paddingTop = '2.5px';
  help_el.style.maxHeight = "173px";
  //help_el.style.overflowY = 'scroll';
  ...
  help_footer.style.borderTop = "4px #4c4c4c solid";
  help_footer.style.marginTop = '2.5px';
  help_footer.style.paddingTop = '2.5px';
